...
class Philly extends BaseStage
{
	...
	override function create()
	{
		...
		phillyWindow = new BGSprite('week3/philly/window', city.x, city.y, 0.3, 0.3);
		...
		phillyStreet = new BGSprite('week3/philly/street', -40, 50);
		add(phillyStreet);
	}
	override function eventPushed(event:funkin.visuals.game.Note.EventNote)
	{
		switch(event.event)
		{
			case "Philly Glow":
				...
				phillyWindowEvent = new BGSprite('week3/philly/window', phillyWindow.x, phillyWindow.y, 0.3, 0.3);
				...
				Paths.image('week3/philly/particle'); //precache philly glow particle image
