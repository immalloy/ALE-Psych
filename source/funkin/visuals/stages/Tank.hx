...
class Tank extends BaseStage
{
	...
	override function create()
	{
		...
		if(!ClientPrefs.data.lowQuality)
		{
			...
			tankWatchtower = new BGSprite('week7/tankWatchtower', 100, 50, 0.5, 0.5, ['watchtower gradient color']);
			add(tankWatchtower);
		}
		...
		if(!ClientPrefs.data.lowQuality) foregroundSprites.add(new BGSprite('week7/tank1', -300, 750, 2, 0.2, ['fg']));
		foregroundSprites.add(new BGSprite('week7/tank2', 450, 940, 1.5, 1.5, ['foreground']));
		if(!ClientPrefs.data.lowQuality) foregroundSprites.add(new BGSprite('week7/tank4', 1300, 900, 1.5, 1.5, ['fg']));
		foregroundSprites.add(new BGSprite('week7/tank5', 1620, 700, 1.5, 1.5, ['fg']));
		if(!ClientPrefs.data.lowQuality) foregroundSprites.add(new BGSprite('week7/tank3', 1300, 1200, 3.5, 2.5, ['fg']));
	...
	function prepareCutscene()
	{
		...
		try
		{
		Paths.loadAnimateAtlas(tankman, 'week7/cutscenes/tankman');
		} catch(e) {
			trace(e);
		}
